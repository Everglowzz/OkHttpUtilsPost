package com.everglow.okhttputilspost.log;
...
final class LoggerPrinter implements Printer {
    ...
    /**
     * Android's max limit for a com.everglow.okhttputilspost.log entry is ~4076 bytes,
    ...
    /**
     * It is used to determine com.everglow.okhttputilspost.log settings such as method count, thread info visibility
     */
    ...
    private synchronized void log(int logType, String msg, Object... args) {
        ...
        if (TextUtils.isEmpty(message)) {
            message = "Empty/NULL com.everglow.okhttputilspost.log message";
        }
    ...
    private void logChunk(int logType, String tag, String chunk) {
        ...
        switch (logType) {
            ...
            case ASSERT:
                ...
                break;
            case DEBUG:
                // Fall through, com.everglow.okhttputilspost.log debug by default
            default:
